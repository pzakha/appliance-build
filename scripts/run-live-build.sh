...
#
# Copy the build-info file generated by the build-ancillary-repository script.
# It will be included in the delphix-entire package.
#
cp "$TOP/live-build/build/build-info" "$build_dir"
